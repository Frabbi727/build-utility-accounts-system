...
return [
    ...
    'expense_confirm_title' => 'এই ব্যয়টি লিপিবদ্ধ করবেন?',
    'expense_confirm_message' => 'ব্যয়টি খতিয়ানে পোস্ট হবে এবং নিচের হিসাব থেকে টাকা কমে যাবে। পরে ফেরাতে হলে ভয়েড করতে হবে।',
    'balance_after' => 'এরপর অবশিষ্ট থাকবে',
    'overdrawn_warning' => 'এতে হিসাবটি শূন্যের নিচে নেমে যাবে। এগোনোর আগে পেমেন্ট পদ্ধতি ও পরিমাণ যাচাই করুন।',
    'voucher' => 'ভাউচার',
